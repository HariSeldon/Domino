...
Box::Box(btTransform &transform, btScalar mass, btVector3 &inertia,
         btVector3 &sidesLengths)
    : Object(transform, mass, inertia) {
  btVector3 tmpHalfSides = sidesLengths / 2;
...
void Box::setupFaces(const glm::vec3& halfSides) {
  ...
  points = {frontTopRight, frontBottomRight, frontBottomLeft, frontTopLeft, // Front.
            backTopRight, backBottomRight, frontBottomRight, frontTopRight, // Right.
            backTopLeft, backBottomLeft, backBottomRight, backTopRight, // Back.
            frontTopLeft, frontBottomLeft, backBottomLeft, backTopLeft, // Left.
            backTopRight, frontTopRight, frontTopLeft, backTopLeft, // Top.
            backBottomLeft, frontBottomLeft, frontBottomRight, backBottomRight // Bottom.
           };
  ...
  glm::vec3 frontNormal = computeNormal(frontTopRight, frontBottomRight, frontBottomLeft);
  glm::vec3 rightNormal = computeNormal(backTopRight, backBottomRight, frontBottomRight);
  glm::vec3 backNormal = computeNormal(backTopLeft, backBottomLeft, backBottomRight);
  glm::vec3 leftNormal = computeNormal(frontTopLeft, frontBottomLeft, backBottomLeft);
  glm::vec3 topNormal = computeNormal(backTopRight, frontTopRight, frontTopLeft);
  glm::vec3 bottomNormal = computeNormal(backBottomLeft, frontBottomLeft, frontBottomRight);
