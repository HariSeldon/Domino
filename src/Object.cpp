...
const float* Object::getPoints() const { return reinterpret_cast<const float*>(points.data()); }
int Object::getPointsNumber() const { return points.size(); }

const float* Object::getNormals() const { return reinterpret_cast<const float*>(normals.data()); }
...
void Object::setAmbientColor(const glm::vec4 &color) {
  ambientColor = color;
}

const glm::vec4& Object::getDiffuseColor() const { return diffuseColor; }
void Object::setDiffuseColor(const glm::vec4& color) {
  diffuseColor = color;
}

const glm::vec4& Object::getSpecularColor() const { return specularColor; }
void Object::setSpecularColor(const glm::vec4& color) {
  specularColor = color;
}
...
ObjectBuilder<Subtype>::ObjectBuilder()
    : ambientColor(glm::vec4(1.f, 1.f, 1.f, 1.f)),
      ...
      specularColor(glm::vec4(0.f, 0.f, 0.f, 1.f)),
      shininess(0.0f) {}
...
//template <class Subtype>
//Object* ObjectBuilder<Subtype>::create() {
//  return nullptr;
//}
...
//template class ObjectBuilder<SphereBuilder>;
...
//template class ObjectBuilder<WedgeBuilder>;
